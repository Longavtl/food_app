...
class _CheckboxPainter extends ToggleablePainter {
  ...
  Rect _outerRectAt(Offset origin, double t) {
    ...
    final double size = sizeValue.size - inset * sizeValue.strokeWidth;
    final Rect rect =
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    Offset start = Offset(sizeValue.size * 0.2, sizeValue.size * 0.45);
    Offset mid = Offset(sizeValue.size * 0.4, sizeValue.size * 0.7);
    Offset end = Offset(sizeValue.size * 0.80, sizeValue.size * 0.25);
    if (t < 0.5) {
  ...
  void _drawDash(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    // mid point outwards.
    Offset start = Offset(sizeValue.size * 0.2, sizeValue.size * 0.5);
    Offset mid = Offset(sizeValue.size * 0.5, sizeValue.size * 0.5);
    Offset end = Offset(sizeValue.size * 0.8, sizeValue.size * 0.5);
