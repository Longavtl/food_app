...
class FIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _effectiveColor = color ??
        primaryColor ??
        _defaultIconStyle?.color ??
        FColors.grey10;
    final _effectivePColor = primaryColor ??
        color ??
        _defaultIconStyle?.primaryColor ??
        FColors.grey1;
    final _effectiveSColor = secondaryColor ??
        color ??
        _defaultIconStyle?.secondaryColor ??
        FColors.blue6;
    final _effectiveSize = size ??
        _defaultIconStyle?.size ??
        24;
