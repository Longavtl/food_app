...
import 'package:food_app/features/home/ui/widget_child/list_mon.dart';
import 'package:food_app/features/home/ui/widget_child/search_home.dart';
import 'package:food_app/features/home/ui/widget_child/slide_show.dart';
              ...
              children: [
                ...
                const FractionallySizedBox(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [Text('CHỌN THEO THỂ LOẠI',style: TextStyle(fontSize: 20,fontFamily: 'Times New Roman',fontWeight: FontWeight.bold),),
                        Text('Xem tất cả ',style: TextStyle(decoration: TextDecoration.underline,color: Colors.blue))
                      ]),
                ),
                SizedBox(height: 20,),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [MenuWidget('https://firebasestorage.googleapis.com/v0/b/fir-235c2.appspot.com/o/monchay.jpg?alt=media&token=37d887ed-3006-4e4d-8e6b-e2e1254b5a03','Món chay'),
